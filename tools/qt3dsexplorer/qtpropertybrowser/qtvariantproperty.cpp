    ...
    : QtAbstractPropertyManager(parent), d_ptr(new QtVariantPropertyManagerPrivate)
{
    ...
    QtFloatPropertyManager *floatPropertyManager = new QtFloatPropertyManager(this);
    ...
    connect(floatPropertyManager, SIGNAL(valueChanged(QtProperty*,float)),
                this, SLOT(slotValueChanged(QtProperty*,float)));
    connect(floatPropertyManager, SIGNAL(rangeChanged(QtProperty*,float,float)),
                this, SLOT(slotRangeChanged(QtProperty*,float,float)));
    connect(floatPropertyManager, SIGNAL(singleStepChanged(QtProperty*,float)),
                this, SLOT(slotSingleStepChanged(QtProperty*,float)));
    ...
    QtVector3DPropertyManager *vectorPropertyManager = new QtVector3DPropertyManager(this);
    d_ptr->m_typeToPropertyManager[QVariant::Vector3D] = vectorPropertyManager;
    d_ptr->m_typeToValueType[QVariant::Vector3D] = QVariant::Vector3D;
    connect(vectorPropertyManager, SIGNAL(valueChanged(QtProperty*,QVector3D)),
                this, SLOT(slotValueChanged(QtProperty*,QVector3D)));
    connect(vectorPropertyManager->subDoublePropertyManager(), SIGNAL(valueChanged(QtProperty*,double)),
                this, SLOT(slotValueChanged(QtProperty*,double)));
    connect(vectorPropertyManager, SIGNAL(propertyInserted(QtProperty*,QtProperty*,QtProperty*)),
                this, SLOT(slotPropertyInserted(QtProperty*,QtProperty*,QtProperty*)));
    connect(vectorPropertyManager, SIGNAL(propertyRemoved(QtProperty*,QtProperty*)),
                this, SLOT(slotPropertyRemoved(QtProperty*,QtProperty*)));
    // EnumPropertyManager
...
void QtVariantPropertyManager::setValue(QtProperty *property, const QVariant &val)
{
    ...
    if (QtIntPropertyManager *intManager = qobject_cast<QtIntPropertyManager *>(manager)) {
        ...
        return;
    } else if (QtFloatPropertyManager *floatManager = qobject_cast<QtFloatPropertyManager *>(manager)) {
