...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void slotValueChanged(QtProperty *, float))
    Q_PRIVATE_SLOT(d_func(), void slotRangeChanged(QtProperty *, float, float))
    Q_PRIVATE_SLOT(d_func(), void slotSingleStepChanged(QtProperty *, float))
